...
glm::vec3 lightPositionluzAzul(500.0f, 0.0f, 90.0f);
glm::vec3 lightDirection(0.0f, -1.0f, -1.0f); 
glm::vec3 colorl1(1.0f, 0.5f, 0.0f);
glm::vec3 colorl2(0.6f, 0.2f, 0.4f);
glm::vec3 colorl3(0.0f, 0.0f, 0.0f);
double VariableCirculo = 0.0;
double cambioColor = 0.0;
double animacionluz2 = 0.0;
...
void animate(void)
{
	lightPosition.x = 25.0 * cos(VariableCirculo);
	lightPosition.z = 25.0 * sin(VariableCirculo);
	VariableCirculo += 0.1;

	colorl1.x = 80.0*sin(cambioColor);
	colorl1.y = 120.0*cos(cambioColor);
	colorl1.z = 50.0*sin(cambioColor);
	colorl2.x = 65.0*cos(cambioColor);
	colorl2.y = 100.0*sin(cambioColor);
	colorl2.z = 70.0*cos(cambioColor);
	cambioColor += 0.01;

	lightPositionluzAzul.x = 50.0 * cos(animacionluz2) * (30.0 * sin(animacionluz2));
	lightPositionluzAzul.z = 25.0 * cos(animacionluz2) * (15.0 * sin(animacionluz2));
	animacionluz2 += 0.01;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setVec3("pointLight[1].position", lightPositionluzAzul);
		staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.0f, 0.0f, 0.7f));  
		...
		staticShader.setVec3("pointLight[2].position", glm::vec3(-80.0, 0.0f, 80.0f));
		staticShader.setVec3("pointLight[2].ambient", colorl1);  
		staticShader.setVec3("pointLight[2].diffuse", colorl2);
		staticShader.setVec3("pointLight[2].specular", colorl3);
		...
		//model = glm::translate(glm::mat4(1.0f), glm::vec3(70.0f, 25.0f,0.0f));
...
void my_input(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	/*if (key == GLFW_KEY_SPACE && action == GLFW_PRESS)
		animacion ^= true;
	if (key == GLFW_KEY_L && action == GLFW_PRESS && movAuto_z > 200.0f)  
		movAuto_z = 0.0f;*/
	if (key == GLFW_KEY_P && action == GLFW_PRESS && movAuto_z > 60.5f) 
		movAuto_z = 0.0f;
