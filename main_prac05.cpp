...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelOp = glm::rotate(modelOp, glm::radians(hombro), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelOp = glm::rotate(modelOp, glm::radians(-dedo1parte1), glm::vec3(0.0f, 0.0f, 1.0f));
		temp02 = modelOp = glm::translate(modelOp, glm::vec3(0.375f, 0.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.75f, 0.3f, 0.25f));
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 1.0f));
		glDrawArrays(GL_TRIANGLES, 0, 36);	//Dibujo de elemento G

		modelOp = glm::translate(temp02, glm::vec3(0.375f, 0.0f, 0.0f));
		modelOp = glm::rotate(modelOp, glm::radians(-dedo1parte2), glm::vec3(0.0f, 0.0f, 1.0f));
