...
void LoadTextures()
{
	...
	t_diaMuertos = generateTextures("Texturas/diaMuertos.png", 1);
	t_dado = generateTextures("Texturas/Cube03.png", 1);
}
...
void myData()
{
	...
	GLfloat verticesCubo[] = {
		...
		-0.5f, 0.5f,  0.5f,		0.25f, 0.6666f,	//V4 - Sup
		 0.5f, 0.5f,  0.5f,		0.50f, 0.6666f,	//V5
		 0.5f, 0.5f, -0.5f,		0.50f, 1.0000f,	//V6
		-0.5f, 0.5f,  0.5f,		0.25f, 0.6666f,	//V4
		-0.5f, 0.5f, -0.5f,		0.25f, 1.0000f,	//V7
		 0.5f, 0.5f, -0.5f,		0.50f, 1.0000f,	//V6

		-0.5f, -0.5f,  0.5f,	0.25f, 0.3333f,	//V0 - Inf
		-0.5f, -0.5f, -0.5f,	0.25f, 0.0000f,	//V3
		 0.5f, -0.5f, -0.5f,	0.50f, 0.0000f,	//V2
		-0.5f, -0.5f,  0.5f,	0.25f, 0.3333f,	//V0
		 0.5f, -0.5f, -0.5f,	0.50f, 0.0000f,	//V2
		 0.5f, -0.5f,  0.5f,	0.50f, 0.3333f,	//V1
	};
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glBindTexture(GL_TEXTURE_2D, t_diaMuertos);
